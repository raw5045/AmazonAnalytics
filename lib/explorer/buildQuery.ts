...
import { sortNullKeyColumn, sortUsesVolumeDelta } from './sortRules';

export { sortHidesRows, sortNullKeyColumn, sortUsesVolumeDelta } from './sortRules';
...
// sortUsesVolumeDelta / sortNullKeyColumn / sortHidesRows live in ./sortRules
// (shared with the filter sidebar's hint copy) and are re-exported above.
